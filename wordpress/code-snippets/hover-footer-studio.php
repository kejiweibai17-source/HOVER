                            ...
                            <div class="hfs-card-body">
                                <div class="hfs-logo-section">
                                    <div class="hfs-logo-preview-wrap">
                                        ...
                                        <input type="hidden" data-field="logo.url"
                                            value="<?php echo esc_attr($s['logo']['url']); ?>">
                                        <input type="hidden" data-field="logo.mimeType"
                                            value="<?php echo esc_attr($s['logo']['mimeType'] ?? ''); ?>">
                                        <div class="hfs-actions">
                                            <button type="button" class="button button-primary hfs-pick-media"
                                                data-target="logo.url" data-preview="hfs-logo-preview">選擇圖片</button>
                                            <button type="button" class="button hfs-clear-media" data-target="logo.url"
                                                data-preview="hfs-logo-preview">清除</button>
                                        </div>
                                        <p class="description" style="margin:0">支援 PNG、JPG、WebP、<strong>SVG</strong>。SVG
                                            可搭配下方「Logo 顏色」著色。</p>
                                    </div>
                                    ...
                                    <div class="hfs-logo-meta">
                                        <div class="hfs-grid-2">
                                            <div class="hfs-field">
                                                ...
                                                <input type="text" class="regular-text" data-field="logo.alt"
                                                    value="<?php echo esc_attr($s['logo']['alt']); ?>">
                                            </div>
                                            <div class="hfs-field">
                                                <label class="hfs-label">Logo 連結</label>
                                                <input type="text" class="regular-text" data-field="logo.link"
                                                    value="<?php echo esc_attr($s['logo']['link']); ?>" placeholder="/">
                                            </div>
                                            <div class="hfs-field">
                                                <label class="hfs-label">Logo 顏色</label>
                                                <input type="color" data-field="logo.color"
                                                    value="<?php echo esc_attr($s['logo']['color']); ?>">
                                    ...
                                    <div class="hfs-logo-color">
                                        <div class="hfs-field">
                                            ...
                                            <input type="color" data-field="backgroundColor"
                                                value="<?php echo esc_attr($s['backgroundColor']); ?>">
                    ...
                    <section class="hfs-panel" id="hfs-tab-contact">
                        <div class="hfs-card">
                            ...
                            <div class="hfs-card-body hfs-grid-2">
                                <div class="hfs-field"><label class="hfs-label">區塊標題</label><input type="text"
                                        class="regular-text" data-field="contact.title"
                                        value="<?php echo esc_attr($s['contact']['title']); ?>"></div>
                                <div class="hfs-field"><label class="hfs-label">Email（mailto 用）</label><input
                                        type="email" class="regular-text" data-field="contact.email"
                                        value="<?php echo esc_attr($s['contact']['email']); ?>"></div>
                                <div class="hfs-field"><label class="hfs-label">Email 顯示文字</label><input type="text"
                                        class="regular-text" data-field="contact.emailLabel"
                                        value="<?php echo esc_attr($s['contact']['emailLabel']); ?>"></div>
                                <div class="hfs-field"><label class="hfs-label">營業時間</label><input type="text"
                                        class="regular-text" data-field="contact.hours"
                                        value="<?php echo esc_attr($s['contact']['hours']); ?>"></div>
                                <div class="hfs-field"><label class="hfs-label">LINE ID 顯示</label><input type="text"
                                        class="regular-text" data-field="contact.lineId"
                                        value="<?php echo esc_attr($s['contact']['lineId']); ?>"></div>
                                <div class="hfs-field"><label class="hfs-label">LINE 連結</label><input type="url"
                                        class="regular-text" data-field="contact.lineUrl"
                                        value="<?php echo esc_attr($s['contact']['lineUrl']); ?>"></div>
                                <div class="hfs-field hfs-span-2"><label
                                        class="hfs-label">公司名稱與統編（顯示於聯絡我們）</label><input type="text"
                                        class="regular-text" data-field="contact.companyInfo"
                                        value="<?php echo esc_attr($s['contact']['companyInfo']); ?>"></div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="hfs-card-body">
                                <div class="hfs-field">
                                    ...
                                    <textarea rows="3" class="large-text"
                                        data-field="copyright"><?php echo esc_textarea($s['copyright']); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </section>
...
.hover-footer-admin .hfs-topbar h1 {
    margin: 0 0 6px;
}
...
.hover-footer-admin .hfs-tab:hover {
    border-color: #2a514d;
    color: #2a514d;
}
...
.hover-footer-admin .hfs-panel {
    display: none;
}

.hover-footer-admin .hfs-panel.is-active {
    display: block;
}
...
.hover-footer-admin .hfs-card-head h2 {
    margin: 0;
    font-size: 14px;
    font-weight: 700;
}

.hover-footer-admin .hfs-card-body {
    padding: 18px;
}
...
.hover-footer-admin .hfs-field {
    display: flex;
    flex-direction: column;
    gap: 6px;
}

.hover-footer-admin .hfs-label {
    font-weight: 600;
    font-size: 13px;
}

.hover-footer-admin .hfs-stack {
    display: flex;
    flex-direction: column;
    gap: 12px;
}
...
.hover-footer-admin .hfs-block-head input {
    font-weight: 700;
}
...
.hover-footer-admin .hfs-social-card {
    display: grid;
    grid-template-columns: 52px 1fr 1fr 130px auto auto;
    gap: 10px;
    align-items: end;
}
...
.hover-footer-admin .hfs-icon-preview img {
    width: 100%;
    height: 100%;
    object-fit: contain;
}
...
.hover-footer-admin .hfs-logo-preview img {
    max-width: 100%;
    max-height: 100%;
    object-fit: contain;
}
...
.hover-footer-admin .hfs-reset-form {
    margin-top: 8px;
}

.hover-footer-admin .hfs-preview {
    position: sticky;
    top: 32px;
}

.hover-footer-admin .hfs-preview-body {
    padding: 12px;
    background: #f6f7f7;
}
...
.hover-footer-admin .hfs-mt {
    margin-top: 16px;
}

.hover-footer-admin .hfs-mb {
    margin-bottom: 14px;
}
...
jQuery(function($) {
    ...
    function logoMarkup(url, alt, color, mime) {
        ...
        if (isSvgAsset(url, mime)) {
            return '<div class="hfs-logo-svg-inline" data-svg-url="' + esc(url) + '" data-svg-color="' + esc(
                color || '#ffffff') + '"></div>';
        }
    ...
    function renderColumns() {
        ...
        (state.columns || []).forEach(function(col) {
            ...
            $head.append(
                '<input type="text" class="regular-text col-title" placeholder="欄位標題" value="' +
                esc(col.title) + '">');
            ...
            (col.links || []).forEach(function(link) {
                $links.append(
                    ...
                    '<input type="text" class="regular-text link-label" placeholder="連結文字" value="' +
                    esc(link.label) + '">' +
                    '<input type="text" class="regular-text link-href" placeholder="網址或 /path" value="' +
                    esc(link.href) + '">' +
            ...
            $block.append($links);
            $block.append(
                '<button type="button" class="button add-link"><span class="dashicons dashicons-plus-alt2"></span> 新增連結</button>'
                );
            $wrap.append($block);
        });
    }
    ...
    function renderSocial() {
        ...
        (state.social || []).forEach(function(item) {
            var opts = Object.keys(icons).map(function(k) {
                return '<option value="' + k + '"' + (item.icon === k ? ' selected' : '') +
                    '>' + esc(icons[k]) + '</option>';
            }).join('');
            var preview = item.iconUrl ? '<img src="' + esc(item.iconUrl) + '" alt="">' : esc((item
                .icon || '').toUpperCase());
            $wrap.append(
                '<div class="hfs-block hfs-social-item">' +
                '<div class="hfs-social-card">' +
                '<div class="hfs-icon-preview social-preview">' + preview + '</div>' +
                '<input type="text" class="regular-text social-label" placeholder="名稱" value="' +
                esc(item.label) + '">' +
                '<input type="text" class="regular-text social-href" placeholder="連結" value="' +
                esc(item.href) + '">' +
    ...
    function syncFromDom() {
        ...
        $('#hfs-columns .hfs-block').each(function() {
            ...
            $(this).find('.hfs-link-row').each(function() {
                ...
                if (label && href) links.push({
                    label: label,
                    href: href
                });
            });
            if (title) state.columns.push({
                title: title,
                links: links
            });
        });
    ...
    function renderPreview() {
        ...
        if (state.logo && state.logo.url) {
            ...
            html += '<span class="hfs-phone-logo-text" style="color:' + esc(state.logo.color || '#ffffff') +
                '">HOVER</span>';
        }
        html += '</div>';
    ...
    $(document).on('click', '.add-link', function() {
        $(this).before(
            '<div class="hfs-link-row"><input type="text" class="regular-text link-label" placeholder="連結文字"><input type="text" class="regular-text link-href" placeholder="網址或 /path"><button type="button" class="button-link del-link">刪</button></div>'
            );
        renderPreview();
    });

    $(document).on('click', '.del-link', function() {
        $(this).closest('.hfs-link-row').remove();
        renderPreview();
    });
    $(document).on('click', '.del-col', function() {
        $(this).closest('.hfs-block').remove();
        renderPreview();
    });
    $(document).on('click', '.del-social', function() {
        $(this).closest('.hfs-social-item').remove();
        renderPreview();
    });
