...
function hmvs_render_page(): void
{
        ...
        <div class="hmvs-shell">
            ...
            <form id="hmvs-form" method="post">
                ...
                <div class="hmvs-layout">
                    <div class="hmvs-main">
                        <div class="hmvs-card">
                            <div class="hmvs-card-head"><h2>顯示設定</h2></div>
                            <div class="hmvs-card-body hmvs-stack">
                                ...
                                <div class="hmvs-grid-3">
                                    <label class="hmvs-switch">
                                        <input type="checkbox" data-field="autoplay" <?php checked(!empty($s['autoplay'])); ?>>
                                        <span class="hmvs-switch-ui"></span>
                        ...
                        <div class="hmvs-card">
                            <div class="hmvs-card-head"><h2>文字與連結</h2></div>
                            <div class="hmvs-card-body hmvs-stack">
                                <div class="hmvs-field">
                                    <label class="hmvs-label">區塊標題</label>
                                    <input type="text" class="large-text" data-field="title" value="<?php echo esc_attr($s['title']); ?>" placeholder="選填">
                                </div>
                                <div class="hmvs-field">
                                    <label class="hmvs-label">文字說明</label>
                                    <textarea rows="3" class="large-text" data-field="body" placeholder="選填"><?php echo esc_textarea($s['body']); ?></textarea>
                                </div>
                                <div class="hmvs-field">
                                    <label class="hmvs-label">點擊後連結</label>
                                    <input type="text" class="regular-text" data-field="href" value="<?php echo esc_attr($s['href']); ?>" placeholder="/products">
                        ...
                        <div class="hmvs-card">
                            <div class="hmvs-card-head"><h2>桌機版媒體</h2></div>
                            <div class="hmvs-card-body hmvs-media-row">
                                <div class="hmvs-field">
                                    ...
                                    <input type="hidden" data-field="desktop.videoUrl" value="<?php echo esc_attr($s['desktop']['videoUrl']); ?>">
                                    <div class="hmvs-actions">
                                        <button type="button" class="button button-primary hmvs-pick" data-kind="video" data-field="desktop.videoUrl" data-thumb="hmvs-desk-video-thumb">選影片</button>
                                        <button type="button" class="button hmvs-clear" data-field="desktop.videoUrl" data-thumb="hmvs-desk-video-thumb" data-kind="video">清除</button>
                                    </div>
                                </div>
                                <div class="hmvs-field">
                                    ...
                                    <input type="hidden" data-field="desktop.posterUrl" value="<?php echo esc_attr($s['desktop']['posterUrl']); ?>">
                                    <div class="hmvs-actions">
                                        <button type="button" class="button button-primary hmvs-pick" data-kind="image" data-field="desktop.posterUrl" data-thumb="hmvs-desk-poster-thumb">選封面</button>
                                        <button type="button" class="button hmvs-clear" data-field="desktop.posterUrl" data-thumb="hmvs-desk-poster-thumb" data-kind="image">清除</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hmvs-card">
                            <div class="hmvs-card-head"><h2>手機版媒體</h2></div>
                            <div class="hmvs-card-body">
                                ...
                                <div class="hmvs-media-row">
                                    <div class="hmvs-field">
                                        ...
                                        <input type="hidden" data-field="mobile.videoUrl" value="<?php echo esc_attr($s['mobile']['videoUrl']); ?>">
                                        <div class="hmvs-actions">
                                            <button type="button" class="button button-primary hmvs-pick" data-kind="video" data-field="mobile.videoUrl" data-thumb="hmvs-mob-video-thumb">選影片</button>
                                            <button type="button" class="button hmvs-clear" data-field="mobile.videoUrl" data-thumb="hmvs-mob-video-thumb" data-kind="video">清除</button>
                                        </div>
                                    </div>
                                    <div class="hmvs-field">
                                        <label class="hmvs-label">封面圖片</label>
                                        ...
                                        <input type="hidden" data-field="mobile.posterUrl" value="<?php echo esc_attr($s['mobile']['posterUrl']); ?>">
                                        <div class="hmvs-actions">
                                            <button type="button" class="button button-primary hmvs-pick" data-kind="image" data-field="mobile.posterUrl" data-thumb="hmvs-mob-poster-thumb">選封面</button>
                                            <button type="button" class="button hmvs-clear" data-field="mobile.posterUrl" data-thumb="hmvs-mob-poster-thumb" data-kind="image">清除</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>window.HMVS_DATA = <?php echo $payload ?: '{}'; ?>;</script>
    <?php
...
function hmvs_print_admin_styles(): void
{
    ?>
    <style>
        .hover-mid-video-admin { max-width: 1180px; }
        .hover-mid-video-admin .hmvs-shell { margin-top: 8px; }
        .hover-mid-video-admin .hmvs-topbar {
            display: flex; align-items: flex-start; justify-content: space-between;
            gap: 16px; margin-bottom: 16px;
        }
        .hover-mid-video-admin .hmvs-topbar h1 { margin: 0 0 6px; }
        ...
        .hover-mid-video-admin .hmvs-status.is-live { background: #edf7f1; color: #1a6847; }
        ...
        .hover-mid-video-admin .hmvs-card-head h2 { margin: 0; font-size: 14px; font-weight: 700; }
        .hover-mid-video-admin .hmvs-card-body { padding: 18px; }
        .hover-mid-video-admin .hmvs-stack { display: flex; flex-direction: column; gap: 14px; }
        .hover-mid-video-admin .hmvs-grid-3 {
            display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;
        }
        .hover-mid-video-admin .hmvs-field { display: flex; flex-direction: column; gap: 6px; }
        .hover-mid-video-admin .hmvs-label { font-weight: 600; font-size: 13px; }
        .hover-mid-video-admin .hmvs-actions { display: flex; gap: 6px; flex-wrap: wrap; }
        ...
        .hover-mid-video-admin .hmvs-switch input { position: absolute; opacity: 0; pointer-events: none; }
        .hover-mid-video-admin .hmvs-switch-ui {
            width: 40px; height: 22px; border-radius: 999px; background: #c3c4c7; position: relative; transition: .2s; flex-shrink: 0;
        }
        ...
        .hover-mid-video-admin .hmvs-switch input:checked + .hmvs-switch-ui { background: #2a514d; }
        .hover-mid-video-admin .hmvs-switch input:checked + .hmvs-switch-ui::after { transform: translateX(18px); }
        .hover-mid-video-admin .hmvs-switch-label { font-weight: 600; font-size: 13px; }
        .hover-mid-video-admin .hmvs-thumb {
            ...
            color: #646970; font-size: 12px; text-align: center; position: relative;
        }
        .hover-mid-video-admin .hmvs-thumb img,
        .hover-mid-video-admin .hmvs-thumb video { width: 100%; height: 100%; object-fit: cover; display: block; background: #111; }
        ...
        .hover-mid-video-admin .hmvs-media-meta {
            margin-top: 4px; font-size: 11px; color: #646970; word-break: break-all; line-height: 1.35; min-height: 1.2em;
        }
        .hover-mid-video-admin .hmvs-preview { position: sticky; top: 32px; }
        .hover-mid-video-admin .hmvs-preview-body {
            padding: 14px; background: #e8ecef; display: flex; flex-direction: column; gap: 14px;
        }
        .hover-mid-video-admin .hmvs-device-label {
            font-size: 11px; font-weight: 700; letter-spacing: .08em; color: #646970; margin-bottom: 6px;
        }
        .hover-mid-video-admin .hmvs-mock {
            position: relative; width: 100%; aspect-ratio: 16/9; border-radius: 6px; overflow: hidden; background: #222;
        }
        .hover-mid-video-admin .hmvs-mock.is-mobile { max-width: 160px; aspect-ratio: 9/16; margin: 0 auto; }
        .hover-mid-video-admin .hmvs-mock img,
        .hover-mid-video-admin .hmvs-mock video { width: 100%; height: 100%; object-fit: cover; display: block; }
        ...
        .hover-mid-video-admin .hmvs-mock-title { margin: 0; font-size: 14px; font-weight: 700; }
        .hover-mid-video-admin .hmvs-mock-body { margin: 0; font-size: 11px; opacity: .9; white-space: pre-line; }
        .hover-mid-video-admin .hmvs-reset-form { margin-top: 8px; }
        @media (max-width: 980px) {
            .hover-mid-video-admin .hmvs-layout { grid-template-columns: 1fr; }
            .hover-mid-video-admin .hmvs-preview { position: static; }
            .hover-mid-video-admin .hmvs-media-row,
            .hover-mid-video-admin .hmvs-grid-3 { grid-template-columns: 1fr; }
        }
    </style>
    <?php
}
...
function hmvs_admin_footer_script(): void
{
    ...
    jQuery(function($){
        ...
        if (!state.desktop) state.desktop = { videoUrl: '', posterUrl: '' };
        if (!state.mobile) state.mobile = { videoUrl: '', posterUrl: '' };
        ...
        function readFields(){
            ...
            if (!state.desktop || typeof state.desktop !== 'object') {
                state.desktop = { videoUrl: '', posterUrl: '' };
            }
            if (!state.mobile || typeof state.mobile !== 'object') {
                state.mobile = { videoUrl: '', posterUrl: '' };
            }
        }
        ...
        function mockHtml(label, videoUrl, posterUrl, isMobile){
            ...
            if (videoUrl) {
                html += '<video src="'+esc(videoUrl)+'"'+(posterUrl ? ' poster="'+esc(posterUrl)+'"' : '')+' muted autoplay loop playsinline preload="auto"></video>';
                html += '<span class="hmvs-thumb-badge" style="position:absolute;left:8px;bottom:8px">VIDEO</span>';
            } else if (posterUrl) {
                html += '<img src="'+esc(posterUrl)+'" alt="">';
            } else {
                html += '<div style="display:flex;align-items:center;justify-content:center;height:100%;color:#aaa;font-size:12px">尚未設定媒體</div>';
            }
        ...
        $(document).on('input change', 'input[data-field], textarea[data-field], select[data-field]', renderPreview);
        ...
        $(document).on('click', '.hmvs-pick', function(){
            ...
            var frame = wp.media({
                ...
                button: { text: isVideo ? '使用這支影片' : '使用這張圖' },
                multiple: false,
